...
TODO: Update the individual items in index.html to use different images and titles
TODO: Allow the plugin to take an argument to control the speed of the animations
